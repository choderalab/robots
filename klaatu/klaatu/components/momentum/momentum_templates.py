...
class MomentumFactory(object):
    ...
    @staticmethod
    def evo_run_singleplate(script, plate_id, start_pos, end_pos):
    ...
    @staticmethod
    def centrifuge_spin(plate_id, bucket=0, duration='00:00:10', velocity='500'):
        ...
        return {
            ...
            'action': "'[Spin]'",
            'type': "'step'",
            'containers': [{'id': "'" + plate_id + "'", 'in': bucket_name}],
            'params': {'BucketNumberToLoad': bucket_name, 'Enabled': "'Yes'", 'AccelerationPercent': "'50'", 'Comments': "''", 'SpinTimeAtCruiseVelocity': "'" + duration + "'", 'Duration': "'" + duration + "'",
                       'RunOnAbortedIteration': "'No'", 'Result': "''", 'SpinGs': "'" + velocity + "'", 'DecelerationPercent': "'50'"}}

    @staticmethod
    def flow_if(condition, true_steps, false_steps=[]):
    ...
    @staticmethod
    def momentum_variable(name, var_type='String', default="''", prompt="'No'", comments="''", persist="'No'"):
    ...
    @staticmethod
    def momentum_container(key, container):
