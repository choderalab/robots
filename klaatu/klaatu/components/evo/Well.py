...
import klaatu.util.evo.Units as u
...
class Well:
    """
    A well is a liquid holding site on a plate. It contains specifications about the liquid mixture and its associated _p on a plate
    """
